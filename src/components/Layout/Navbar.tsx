...
const navigation = [
  ...
  { name: "Red Team", href: "/red-team-showcase" },
            ...
            <Link
              ...
              className={cn(
                ...
                location.pathname === item.href
                  ? "text-foreground"
                  : "text-foreground/60",
                "after:absolute after:block after:w-full after:h-[1px] after:bottom-0 after:left-0 after:scale-x-0 after:transition-transform after:duration-300 after:bg-foreground",
                location.pathname === item.href
                  ? "after:scale-x-100"
