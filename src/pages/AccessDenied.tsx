...
const AccessDenied = () => {
    ...
    return (
        <div className="min-h-screen bg-black text-red-500 font-mono flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="z-10 max-w-2xl w-full border border-red-900/50 bg-black/90 p-8 rounded-lg shadow-[0_0_50px_rgba(220,38,38,0.2)] relative">
                {/* Animated Corner Borders */}
                <div className="absolute top-0 left-0 w-4 h-4 border-l-2 border-t-2 border-red-600"></div>
                <div className="absolute top-0 right-0 w-4 h-4 border-r-2 border-t-2 border-red-600"></div>
                <div className="absolute bottom-0 left-0 w-4 h-4 border-l-2 border-b-2 border-red-600"></div>
                ...
                <div className="flex flex-col items-center text-center space-y-6">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black tracking-tighter glitch-text">
                        403 FORBIDDEN
                    </h1>
                    ...
                    <div className="space-y-4 font-mono text-sm md:text-base">
                        <p className="typing-effect min-h-[1.5rem] text-red-400">
                            {text}<span className="animate-pulse">_</span>
                        </p>

                        <div className="bg-red-950/20 p-4 rounded border border-red-900/30 text-left space-y-2">
                    ...
                    <div className="pt-8">
                        <Link to="/">
                            <Button variant="outline" className="border-red-600 text-red-500 hover:bg-red-950/50 hover:text-red-400 font-mono transition-all duration-300">
                                &lt; RETURN_TO_BASE /&gt;
                            </Button>
                        </Link>
                    </div>
